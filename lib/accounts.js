...
const initialWallet = new ethers.Wallet('0x56289e99c94b6912bfc12adc093c9b51124f0dc54ac7a766b2bc5ccf558d8027', provider)
...
async function initAmount(amount) {
    const wallets = getWallets(provider);

    for (const wallet of wallets) {
        const to = wallet.getAddress();
        const res = await initialWallet.sendTransaction({
            to: to,
